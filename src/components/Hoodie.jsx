...
// //             color,
// //             shadow: { blur: 3, offsetX: 1, offsetY: 1, color:
// //             "rgba(255, 0, 0, 0.3)" },
// //           },
// //           modern: {
...
//           // Apply x-axis limits for sleeves
//           let newX = localPosition.x;
//           if (selectedTab === "leftSleeve") {
//             newX = Math.max(-0.73, Math.min(-0.73, localPosition.x)); // Limit x movement for left sleeve
//           } else if (selectedTab === "rightSleeve") {
//             newX = Math.max(0.75, Math.min(0.75, localPosition.x)); // Limit x movement for right sleeve
//           }

//           setDecalPositions((prev) => ({
//             ...prev,
//             [selectedTab]: [newX, localPosition.y, prev[selectedTab][2]],
//           }));
//         }
//       }
//     } else if (activeHandle === "resize") {
...
//         newScale = Math.max(0.05, Math.min(0.3, newScale)); // Limit scale for sleeves
//       }
